...
gsap.from(flowCards, {
    opacity: 0,
    scale: 0.96,           // Card apni hi jagah par thoda chhota hoke bada hoga
    duration: 0.6,         // Animation fast aur crisp hogi
    stagger: 0.08,         // Halki si premium sequential feel ke liye
    ease: "power2.out",
    scrollTrigger: {
